// lets use mailtrap to send mail, 'cause postmark requeire a working mail/purchased domain
// https://api-docs.mailtrap.io/docs/mailtrap-api-docs/67f1d70aeb62c-send-email
...
mod tests {
    ...
    use fake::{Fake, Faker};
    use secrecy::Secret;
    use wiremock::matchers::{any, header, header_exists, method, path_regex};
